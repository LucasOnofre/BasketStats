...
public class GamesAdapter extends RecyclerView.Adapter<GamesAdapter.CustomViewHolder> {
    ...
    class CustomViewHolder extends RecyclerView.ViewHolder {
        ...
        CustomViewHolder(View itemView) {
            ...
            alwayTeamLogo      = view.findViewById(R.id.awayTeamLogo);
            otherTeamScore     = view.findViewById(R.id.awayTeamScore);
            choosenTeamScore   = view.findViewById(R.id.homeTeamScore);
            otherTeamInitial   = view.findViewById(R.id.awayTeamInitial);
